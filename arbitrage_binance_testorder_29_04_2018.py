...
##Convert all Values to USDT
tot_qty_usdtbtc *= wprice_btcusdt
tot_qty_btcusdt *= wprice_btcusdt
tot_qty_btceth *= wprice_ethbtc*wprice_btcusdt
tot_qty_ethbtc *= wprice_ethbtc*wprice_btcusdt
tot_qty_usdteth *= wprice_ethusdt
tot_qty_ethusdt *= wprice_usdteth


liquid = 10.0 ## available for trading in USDT
fee = 0.003*liquid ## 0.1% x amount of tradies x liquid


if(tot_qty_btcusdt >= liquid/wprice_btcusdt
and tot_qty_btcusdt >= liquid/wprice_btcusdt
and tot_qty_btceth >= liquid/wprice_ethusdt
and tot_qty_ethbtc >= liquid/wprice_ethusdt
and tot_qty_usdteth >= liquid/wprice_ethusdt
and tot_qty_ethusdt >= liquid/wprice_ethusdt):
...
if d_btc < fee_fake_btc and d_eth < fee_fake_eth:
    ...
    print('Done back to USDT, final balance: ' + str(balance_btc*wprice_btcusdt))
