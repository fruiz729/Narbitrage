...
if  f_btc_liquid <= liquid and f_eth_liquid <= 100:
...
##    print('No profit because of fee')
...
elif f_btc_liquid >= f_eth_liquid:
    ...
    print('fee ' + str(fee_eth))
    print('after fee: ' + str(balance_eth))
#   print('bought ethereum with USDT')
    ...
    print('fee ' + str(fee_btc))
    print('after fee ' + str(balance_btc))
#   print('bought bitcoin with ehtereum')
    ...
    print('fee ' + str(fee_usdt))
    print('after fee ' +str(balance_usdt))
    
#    print('Done back to USDT, final balance: ' + str(round(balance_btc*wprice_btcusdt,2)))
           
elif f_eth_liquid > f_btc_liquid:
