...
if f_eth_liquid > f_btc_liquid:
    ...
    ## USDT -> ETH -> BTC -> USDT
    simbalance_eth = round(liquid/wprice_usdteth, 5)
    simfee_eth = simbalance_eth*0.001
    simbalance_eth -= simfee_eth
    simbalance_eth = round(simbalance_eth, 5)

    simbalance_btc = round(simbalance_eth*wprice_ethbtc, 3)
    simfee_btc = simbalance_btc * 0.001
    simbalance_btc -= simfee_btc
    simbalance_btc = round(simbalance_btc, 6)

    simbalance_usdt = round(simbalance_btc*wprice_btcusdt, 2)
    simfee_usdt = simbalance_usdt * 0.001
    simbalance_usdt -= simfee_usdt
...
#print('wprice_usdteth ' +str(wprice_usdteth))
#print('wprice_ethbtc ' + str(wprice_ethbtc))
#print('wprice_btcusdt ' +str(wprice_btcusdt))

#print('wprice_usdtbtc ' +str(wprice_usdtbtc))
#print('wprice_btceth ' +str(wprice_btceth))
#print('wprice_ethusdt ' +str(wprice_ethusdt))
...
if tot_qty_usdtbtc <= 0 or tot_qty_btcusdt <= 0 or tot_qty_ethbtc <= 0 or tot_qty_btceth <= 0 or tot_qty_usdteth <= 0 or tot_qty_ethusdt <= 0:
    print("Not enough quantity in first three orders")
...
#   print('balance_btc ' + str(balance_btc))
    ...
    print('balance_usdt ' +str(balance_usdt))
...
#   print('balance_btc ' +str(balance_btc))
    ...
    balance_eth -= fee_eth
    balance_eth = round(balance_eth, 5)
#    print('balance_eth ' + str(balance_eth)) 
...
profitlist = [liquid, balance_usdt, simbalance_usdte1, simbalance_usdtb1]
